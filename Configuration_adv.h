...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 15*60, 3*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Disable X, Y, E"
  #define MAIN_MENU_ITEM_1_GCODE "M84 X Y E"
