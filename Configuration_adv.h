...
#define HOMING_BUMP_DIVISOR { 2, 2, 25 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 25*60, 3*60 } // Feedrates for manual moves along X, Y, Z, E from panel
